...
WebUI.setText(findTestObject('katalon_herokuapp_login/LoginPage/field_username'), GlobalVariable.username)

WebUI.setText(findTestObject('katalon_herokuapp_login/LoginPage/field_password'), GlobalVariable.pwd)
